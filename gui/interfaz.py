...
# # Función para configurar el Treeview con los datos
# def encabezado(tree):
#     # esta funsion recibe como parametro una treeview que es ventana con las columnas que definimos ene ste codigo
...
#         tree.column(col, anchor="center", width=75)  # aqui se ajusta el año de la tabla
        
#     for row in data:
#         tree.insert("", "end", values=row)

# def mostrar_all_games():
#     # Configuración de la ventana principal
#     root = Tk()
#     root.title("Mostrar lista")
#     root.resizable(0, 0)
